...
<template>
  <div class="flex px-2">
    <div class="w-full border-r border-gray-200 px-2">
      ...
      <div class="flex">
        <div class="w-full">
          <BarChart title="Distribution of Services by Provider" :graph-data="serviceDistributionByProvider" :is-horizontal="false"
      ...
      <div class="flex">
        <div class="w-full">
          <BarChart title="Distribution of Service Applications by provider" :graph-data="applicationDistributionByProvider" :is-horizontal="false" :labels="labelExtractor(applicationDistributionByProvider[0].data)"/>
        </div>
      </div>
      <div class="flex">
        <div class="w-full">
          <div class="flex">
            <div class="w-6/12">
              <LineChart title="Distribution of Service Applications" :graph-data="serviceApplicationsDistribution" :is-horizontal="false"
                         :labels="labelExtractor(serviceApplicationsDistribution[0].data)"/>
            </div>
            <div class="w-6/12">
              <PieChart title="Distribution of Service by Status" :data="[45,35,18]" :labels="['Active','Inactive','Other']"/>
            </div>
          </div>
        </div>
      </div>
