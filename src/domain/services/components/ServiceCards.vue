...
<template>
  ...
  <div class="flex justify-end items-center mb-1">
    <!-- Previous Button -->
    <button
      class="px-1 py-0.5 text-red-600 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"
    ...
    <!-- Next Button -->
    <button
      class="px-1 py-0.5 text-red-600 focus:outline-none focus:ring disabled:opacity-50 disabled:cursor-not-allowed"
      :class="{
