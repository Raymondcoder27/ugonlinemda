...
export const useApplications = defineStore("applications", () => {
  ...
  const dummyServiceRequests: ServiceRequest[] = [
    ...
    { id: 2, requestDate: "2021-09-02", serviceName: "Tax Clearance", status: "Approved", applicant: "Tumuhairwe Rodgers", trackingNo: "TRK-001"},
    { id: 3, requestDate: "2021-09-03", serviceName: "Company Incorporation", status: "Rejected", applicant: "James Kangave", trackingNo: "TRK-001"},
    { id: 4, requestDate: "2021-09-04", serviceName: "Tax Clearance", status: "Pending", applicant: "Mpagi Ronald", trackingNo: "TRK-001"},
  ];
